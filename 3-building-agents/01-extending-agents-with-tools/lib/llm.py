...
class LLM:
    def __init__(
        ...
        api_key: Optional[str] = "voc-145450431316886544440846906e09ca0fde9.91536929"
    ):
        self.model = model
        self.temperature = temperature
        self.client = OpenAI(api_key="voc-145450431316886544440846906e09ca0fde9.91536929") if api_key else OpenAI()
